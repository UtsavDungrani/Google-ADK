...
const SUGGESTIONS = [
  ...
  { label: '30-Day Return Policy FAQ', prompt: 'What is your 30-day return policy and window?' },
  { label: 'International Duty FAQ', prompt: 'Do you offer international shipping and who pays custom duty fees?' },
